        <td valign="top" align="left">
            <table class="ac" width="100%" cellpadding="5" cellspacing="2">
                <tr>
                    <td class="post"><strong><?php echo lang('admin_cp'); ?> - <?php echo lang('site_settings'); ?></strong></td>
                </tr>
                <tr>
                    <td>
...
<?php if($area == "main"){ ?>
                ...
                <tr>
                    <td class="post">
                        <dt><?php echo lang('main_settings'); ?></dt>
                    </td>
                </tr>
                <tr>
                    <td class="form">
               ...
               <tr>
                ...
                <tr>
                    <td class="post">
                        <dt><?php echo lang('time_settings'); ?></dt>
                    </td>
                </tr>
                <tr>
                    <td class="form">
                ...
                <tr>
                    <td class="post">
                        <dt><?php echo lang('cookie_settings'); ?></dt>
                    </td>
                </tr>
                <tr>
                    <td class="form">
...
<?php } else if($area == "register"){ ?>
             <form method="post">
                <tr>
                    <td class="post">
                        <dt><?php echo lang('registration_settings'); ?></dt>
                    </td>
                </tr>
                <tr>
                    <td class="form">
                        <dl class="input">
                            ...
                            <dd><input type="text" id="age_validation" name="age_validation" value="<?php echo switchs($_POST['age_validation'], $config['age_validation']); ?>" class="border" style="width: 10%" /></dd>
                        </dl>
                    </td>
                </tr>
                <tr>
                    <td class="form">
                        <dl class="input">
                            ...
                            <dd><input type="text" id="ul" name="min_name_length" value="<?php echo switchs($_POST['min_name_length'], $config['min_name_length']); ?>" class="border" style="width: 10%" /> <input type="text" id="ul" name="max_name_length" value="<?php echo switchs($_POST['max_name_length'], $config['max_name_length']); ?>" class="border" style="width: 10%" /></dd>
                        </dl>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="post">
                        <dt><?php echo lang('email_settings'); ?></dt>
                    </td>
                </tr>
                <tr>
                    <td class="form">
                ...
                <tr>
                    <td class="post">
                        <dt><?php echo lang('email_template'); ?></dt>
                    </td>
                </tr>
                <tr>
                    <td class="form">
...
<?php } else if($area == "user"){ ?>
             <form method="post">
                <tr>
                    <td class="post">
                        <dt><?php echo lang('user_settings'); ?></dt>
                    </td>
                </tr>
                <tr>
                    <td class="form">
                        <dl class="input">
                            ...
                            <dd><input type="text" id="admin_symbol" name="admin_symbol" value="<?php echo switchs($_POST['admin_symbol'], $config['admin_symbol']); ?>" class="border" style="width: 40%" /></dd>
                        </dl>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="post">
                        <dt><?php echo lang('avatar_settings'); ?></dt>
                    </td>
                </tr>
                <tr>
                    <td class="form">
                ...
                <tr>
                    <td class="form">
                        <dl class="input">
                            ...
                            <dd><input type="text" id="mx" name="avatar_max_width" value="<?php echo switchs($_POST['avatar_max_width'], $config['avatar_max_width']); ?>" class="border" style="width: 10%" /> x <input type="text" id="mx" name="max_name_length" value="<?php echo switchs($_POST['avatar_max_height'], $config['avatar_max_height']); ?>" class="border" style="width: 10%" /></dd>
                        </dl>
                    </td>
                </tr>
                <tr>
...
<?php } else if($area == "topics"){ ?>
             <form method="post">
                <tr>
                    <td class="post">
                        <dt><?php echo lang('topic_settings'); ?></dt>
                    </td>
                </tr>
                <tr>
                    <td class="form">
                        <dl class="input">
                            ...
                            <dd><input type="checkbox" id="show_first_post" name="show_first_post" <?php echo equals($config['show_first_post'], true, ' checked '); ?>/> <label for="show_first_post"><?php echo lang('show_first_post'); ?></label></dd>
                            <dd><input type="checkbox" id="allow_quick_reply" name="allow_quick_reply" <?php echo equals($config['allow_quick_reply'], true, ' checked '); ?>/> <label for="allow_quick_reply"><?php echo lang('show_quick_reply'); ?></label></dd>
                        </dl>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="post">
                        <dt><?php echo lang('message_settings'); ?></dt>
                    </td>
                </tr>
                <tr>
                    <td class="form">
