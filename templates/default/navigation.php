...
?>
	...
	<ul class="main">
		<li><a href="users.php?a=home"><?php echo lang('user_cp'); ?></a></li>
<?php if($user_data['admin']) { ?>
		<li><a href="admin.php"><?php echo lang('admin_cp'); ?></a></li>
<?php } ?>
		<li><a href="logout.php"><?php echo lang('logout_c'); ?></a></li>
<?php 
load_hook('navigation_menu'); 
?>
		<div class="clear"></div>
	</ul>
<?php 
...
?>
		<li><a href="<?php echo $config['url_path']; ?>/message.php?page=<?php echo $page; ?>&amp;reply=<?php echo $topic['id']; ?>" class="nav_link"><?php echo lang('reply_c'); ?></a></li>
<?php 
		} 
	} else { 
?>
		<li><a href="<?php echo $config['url_path']; ?>/message.php?reply=0" class="nav_link"><?php echo lang('start_new_topic'); ?></a></li>
<?php 
	} 
?>
		<div class="clear"></div>
